...
namespace Quantum.Editor {
  ...
  using UnityEngine.Experimental.UIElements;
    ...
    public static class QuantumToolbarUtilities {
        ...
        public static string SoteralabsToolbarZone = "ToolbarZoneRightAlign";
#endif
        ...
        private static void Update()
        {
            if (_toolbar == null)
            {
                ...
                if (_toolbar != null)
                {
                    ...
                    RegisterCallback(SoteralabsToolbarZone, OnGUI);
          ...
          onGUIHandlerFieldInfo.SetValue(container, handler);
            ...
            if (_scenePaths == null || _scenePaths.Length != EditorBuildSettings.scenes.Length)
            {
                ...
                foreach (EditorBuildSettingsScene scene in EditorBuildSettings.scenes)
                {
                    ...
                    string scenePath = Application.dataPath.Substring(0, Application.dataPath.Length - 6) + scene.path;
